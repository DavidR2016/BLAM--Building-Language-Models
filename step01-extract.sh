...
#			$WORKDIR/nwu-sg-$Y/step01.outdir/{}/$SGLANG.txt"
	...
	nohup	$SCRIPTDIR/dir-convert_doc-docx-pdf.pl \
			...
			$WORKDIR/nwu-sg-$Y/step01.outdir/$FDIR/$SGLANG.txt > $WORKDIR/nwu-sg-$Y/step01.log/step01.$FDIR.$SGLANG.log > nohup.$SGLANG.$Y.$FDIR.txt &
	done
	echo =================================
